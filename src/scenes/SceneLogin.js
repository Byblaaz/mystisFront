...
export default class SceneLogin extends BaseScene
{
    ...
    create(){
        ...
        this.background = this.add.image(window.innerWidth / 2, window.innerHeight / 2, 'backgroundLogin').setScale(1)

        this.buttonConnect = this.add.sprite(window.innerWidth / 2, window.innerHeight / 1.4, 'buttonConnect').setScale(0.15).setInteractive();
